<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-header mt-7">
        <span class="menu-header-text">Master &amp; Pages</span>
      </li>
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          <i class="menu-icon tf-icons ri-bubble-chart-line"></i>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Product</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Member</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Pengeluaran</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Pembelian</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Penjualan</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Transaksi Lama</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link">
          ...
          <div data-i18n="Dashboards">Transaksi Baru</div>
          {{-- <div class="badge bg-danger rounded-pill ms-auto">5</div> --}}
        </a>
      </li>

...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/favicon/favicon.ico')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/fonts/remixicon/remixicon.css')}}" />

    <!-- Menu waves for no-customizer fix -->
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/libs/node-waves/node-waves.css')}}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/css/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/css/theme-default.css')}}" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/css/demo.css')}}" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')}}" />
    <link rel="stylesheet" href="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/libs/apex-charts/apex-charts.css')}}" />

    <!-- Page CSS -->

    <!-- Helpers -->
    <script src="{{ asset('materio-bootstrap-html-admin-template-free/assets/vendor/js/helpers.js')}}"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="{{ asset('materio-bootstrap-html-admin-template-free/assets/js/config.js')}}"></script>
  </head>
                          ...
                          <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/payments/gumroad.png')}}"
                                  class="img-fluid"
                                  alt="gumroad"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/payments/mastercard-2.png')}}"
                                  class="img-fluid"
                                  alt="mastercard"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/payments/stripes.png')}}"
                                  class="img-fluid"
                                  alt="stripes"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/payments/american-bank.png')}}"
                                  class="img-fluid"
                                  alt="american"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex align-items-center">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/payments/citi.png')}}"
                                  class="img-fluid"
                                  alt="citi"
                                  height="30"
                                  width="30" />
                        ...
                        <div class="withdraw-content pt-2">
                          <ul class="p-0 m-0">
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/brands/google.png')}}"
                                  class="img-fluid"
                                  alt="google"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/brands/github.png')}}"
                                  class="img-fluid"
                                  alt="github"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/brands/slack.png')}}"
                                  class="img-fluid"
                                  alt="slack"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex mb-4 align-items-center pb-2">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/payments/digital-ocean.png')}}"
                                  class="img-fluid"
                                  alt="digital"
                                  height="30"
                                  width="30" />
                            ...
                            <li class="d-flex align-items-center">
                              <div class="flex-shrink-0 me-4">
                                <img
                                  src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/icons/brands/aws.png')}}"
                                  class="img-fluid"
                                  alt="aws"
                                  height="30"
                                  width="30" />
                        ...
                        <tbody>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/3.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/2.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/7.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <div class="avatar avatar-sm me-4">
                                  <img src="{{ asset('materio-bootstrap-html-admin-template-free/assets/img/avatars/6.png')}}" alt="Avatar" class="rounded-circle" />
                                </div>
                                <div>
